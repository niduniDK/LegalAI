                        ...
                        <div className='min-w-full grid gap-2 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3'>
                          {resources.map((url, index) => {
                            ...
                            return (
                              <Card
                                key={index}
                                className='overflow-hidden hover:shadow-lg transition-all duration-200 border-border/50 hover:border-border w-full'
                              >
                                <CardContent className='p-1'>
                                  <div
                                    className='flex flex-col gap-2 p-2 bg-muted/20 rounded-lg border cursor-pointer hover:bg-muted/40 transition-colors'
