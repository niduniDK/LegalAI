...
const historyItems = [
  {
    ...
    summary:
      'Discussed the process of registering a new business in Sri Lanka, including required documents and fees.',
  ...
  },
  {
    ...
    summary:
      'Reviewed sections related to director responsibilities and company governance.',
  ...
  },
  {
    ...
    summary:
      'Asked about mandatory clauses in employment contracts and termination procedures.',
...
export function HistoryInterface() {
  ...
  React.useEffect(() => {
    const fetchAllChats = async () => {
      ...
      try {
        const response = await fetch(
          `${process.env.NEXT_PUBLIC_API_URL}/chat-history/user_sessions`,
          {
            method: 'GET',
            headers: {
              'Content-Type': 'application/json',
        ...
        const allChats = (data || []).map((chat) => ({
          ...
          summary:
            'Continue your legal conversation and get personalized insights.',
          ...
          const recent = parsed.slice(0, 5).map((doc, index) => {
            ...
            return {
              ...
              summary:
                ...
                doc.summary ||
                'Loading summary for recently viewed document...',
                              ...
                              <div className='text-sm'>
                                {(() => {
                                  ...
                                  if (item.type === 'document') {
                                    ...
                                    const displayPoints = summaryPoints.slice(
                                      0,
                                      2
                                    );
                                    const hasMorePoints =
                                      summaryPoints.length > 2;
                            ...
                            <>
                              <Button
                                ...
                                onClick={() => {
                                  ...
                                  if (
                                    item.url &&
                                    item.url.startsWith(basePath)
                                  ) {
                                    const afterBase = item.url.slice(
                                      basePath.length
                                    );
                                    const parts = afterBase.split('/');
                                    if (parts.length > 1) {
                                  ...
                                  localStorage.setItem(
                                    ...
                                    JSON.stringify({
                                      document: item,
                                      initialQuery:
                                        'Give a summary on this document',
                  ...
                  {allRecentItems.length === 0 ? (
                    <>
                      ...
                      <p className='text-muted-foreground mb-6 max-w-md'>
                        Start exploring documents or chatting to see your recent
                        activity here.
                      </p>
