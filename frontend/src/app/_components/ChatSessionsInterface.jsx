...
export function ChatSessionsInterface() {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/chat-history/sessions`,
        {
          ...
          body: JSON.stringify({
            session_name:
              newSessionName || `New Chat - ${new Date().toLocaleDateString()}`,
          }),
        }
      );
  ...
  const updateSessionName = async (sessionId, newName) => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/chat-history/sessions/${sessionId}`,
        {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
            ...
            <Dialog>
              ...
              <DialogContent className='sm:max-w-[425px]'>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Give your new chat session a name to help you organize your
                    conversations.
                  </DialogDescription>
                </DialogHeader>
          ...
          {isLoading ? (
            ...
            <div className='flex flex-col items-center justify-center py-12 text-center'>
              ...
              <p className='text-muted-foreground mb-6 max-w-md'>
                Start your first conversation to begin building your chat
                history. Each session will be saved here for easy access.
              </p>
            ...
            <>
              <div className='mb-4 text-sm text-muted-foreground'>
                {chatSessions.length} chat session
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  ...
                                  {session.session_name}"? This action cannot be
                                  undone and all messages in this session will
                                  be lost.
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
